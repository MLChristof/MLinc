...
This script reads in two CSVs, equalizes the dates and plots candlestick charts.
...
p.segment(df1.date, df1.high, df1.date, df1.low, color="black")
p.vbar(df1.date[inc], w,  df1.open[inc], df1.close[inc],
   fill_color="#00FF00", line_color="black")
p.vbar(df1.date[dec], w,  df1.open[dec], df1.close[dec],
...
p.segment(df2.date, df2.high, df2.date, df2.low, color="black")
p.vbar(df2.date[inc], w,  df2.open[inc], df2.close[inc],
   fill_color="#00FF00", line_color="black")
p.vbar(df2.date[dec], w,  df2.open[dec], df2.close[dec],
   fill_color="#F2583E", line_color="black")
