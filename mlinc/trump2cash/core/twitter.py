...
if __name__ == '__main__':
    test = Twitter()
    # tweet = test.get_tweet('1085519375224983552')['full_text']
    # tweet = 'I am very happy, love and kisses!'
    # tweet = 'Ford is the best company in the world'

    trump_tweets = test.get_tweets('1085519375224983552')
    ...
    # twitter_api = API(auth_handler=test.twitter_auth,
    #                   retry_count=API_RETRY_COUNT,
    #                   retry_delay=API_RETRY_DELAY_S,
    #                   retry_errors=API_RETRY_ERRORS,
    #                   wait_on_rate_limit=True,
