...
if __name__ == '__main__':
    ...
    conf_path = r'C:\Data\2_Personal\Python_Projects\MLinc\mlinc\oanda\conf_files\conf_dickey_fuller.ini'
    ...
    # auto trade
    data0_close = trader.data_as_dataframe('BCO_USD').close
    data1_close = trader.data_as_dataframe('WTICO_USD').close
    ADF_spread = adfuller(data0_close - data1_close)
    print(ADF_spread[1])
    #TODO: more statistical tests. which correlated?
    #TODO: trend analysis. varying window
    #TODO: threshold correlation, varying window
    #TODO: multi model trading. centjes geven
    #TODO: get out standard after 3 candles, build in safeguard SL
    #TODO: backtesten grof optimizing
